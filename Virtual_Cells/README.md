Only the 'one_per_bag_combined' folder was added in Github, as they are the final files used to calibrate the Virtual tumor (See '3_Virtual_Tumor_Calibrations.R').
